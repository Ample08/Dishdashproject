  ...
  return (
    <View style={styles.root}>
      ...
      <ScrollView
        ...
        <View style={styles.grid}>
          {EVENT_TYPES.map(t => (
            <EventTypeCard
              ...
              onPress={() => patchDraft({eventType: t.key})}
            />
          ))}
        </View>
        ...
        <View style={styles.fields}>
          ...
          <TextField
            ...
            value={draft.guests}
            onChangeText={v => patchDraft({guests: v.replace(/[^0-9]/g, '')})}
            placeholder="e.g. 80"
      ...
      <View style={[styles.ctaBar, {paddingBottom: insets.bottom + 12}]}>
        <CateringButton
          label="Continue"
          onPress={() => navigation.navigate('CateringStep2')}
        />
      </View>
      ...
      <CalendarSheet
        ...
        onSelect={d => patchDraft({dateLabel: formatDate(d)})}
